...
final class PendingChannel {
    ...
    PendingChannel(final int id, final int outboundWindowSize, final int inboundWindowSize, final int outboundMessageCount, final int inboundMessageCount, final long outboundMessageSize, final long inboundMessageSize, final boolean dispatch, final Result<Channel> result) {
        this.id = id;
